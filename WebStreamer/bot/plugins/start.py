...
async def start(b, m):
    ...
    if usr_cmd == "/start":
        ...
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton('Bots Channel', url='TorrentTo_Drive'), InlineKeyboardButton('Support Group', url='TorrentDrive_OffTopic')],
                    [InlineKeyboardButton('Developer', url='TorrentTo_Drive')]
                ]
            ),
            disable_web_page_preview=True
        )
...
async def help_handler(bot, message):
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Support Group", url="TorrentDrive_OffTopic"), InlineKeyboardButton("Bots Channel", url="TorrentTo_Drive")],
                [InlineKeyboardButton("Developer", url="TorrentTo_Drive")]
            ]
        )
    )
